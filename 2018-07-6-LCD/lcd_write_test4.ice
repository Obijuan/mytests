{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "74c603b9-d071-4014-8c17-3a128b30bf14",
          "type": "4c9e4b67cb6c2be36049a9802dcb8dc1fd349138",
          "position": {
            "x": 1816,
            "y": 336
          },
        ...
        {
          "id": "2c274ced-e57f-4a01-8d8f-3095045f82be",
          "type": "basic.info",
          "data": {
            "info": "Resuelto el misterio de la inicializacion.\n\nTal y como está ahora el proyecto, para inicializar y mostrar una 'A' \nhay que hacer lo siguiente:\n\nComando a enviar:\n\n* 0x0C0 (Set). 1 vez\n* 0x00F (Display on/off) 1 vez\n* 0x141 Caracter 'A': 17 veces. Esto es así porque como está configurado\npara 1 línea... por defecto es la segunda línea. Hay que enviar los 16\nde la línea superior, que no se muestran el LCD y a partir del 17 ya\nse ve la primera A :-)",
            "readonly": false
          },
          "position": {
            "x": 808,
        ...
        {
          "id": "b69026dd-fce5-4b9f-a2dd-fe1805580466",
          "type": "basic.info",
          "data": {
            "info": "**Secuencia de inicialización**\n\n* CMD 0x038  SET --> 2 líneas, 8 bits de interfaz\n* CMD 0x00F  Display on/off\n\nAl enviar este ya se puede ver el cursor...\n\n* CMD 0x141  Enviar la A\n",
            "readonly": false
          },
          "position": {
            "x": 824,
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "74c603b9-d071-4014-8c17-3a128b30bf14",
        ...
        },
        {
          "source": {
            "block": "74c603b9-d071-4014-8c17-3a128b30bf14",
            "port": "3ba32eb2-2317-45d5-9071-1418f014d419"
          },
          "target": {
  ...
  "dependencies": {
    "4c9e4b67cb6c2be36049a9802dcb8dc1fd349138": {
      "package": {
        "name": "Serial16",
        "version": "",
        "description": "",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "3ba32eb2-2317-45d5-9071-1418f014d419",
              "type": "basic.output",
              "data": {
                "name": "BH",
                "range": "[7:0]",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "3ba32eb2-2317-45d5-9071-1418f014d419",
                "port": "in"
              },
              "size": 8
            },
