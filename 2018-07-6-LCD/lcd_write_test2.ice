  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "9ff44a7b-d11d-4e4a-9065-5dff987d5a49",
          "type": "basic.code",
          "data": {
            "code": "assign o = i[0];",
            "params": [],
        ...
        {
          "id": "ac648b28-da8f-4f5a-ba10-3954d418cda2",
          "type": "basic.info",
          "data": {
            "info": "\n(Bug solucionado respecto version anterior: los comandos llegan\nal lcd con una pulsacion de retraso)\n\nLa inicializacion todavía no está controlada.\n\nSecuencia estable de arranque:\n\nComando 0x0C0 10 veces\nComando 0x00F 10 veces\ncomando 0x141 17 veces: sale una 'A'  (en el 16 ya se ve el cursor)\n",
            "readonly": false
          },
          "position": {
            "x": 1096,
