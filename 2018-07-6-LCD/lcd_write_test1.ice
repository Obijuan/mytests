  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "a4fd391e-1c22-4610-813d-2943b5fe0483",
          "type": "basic.code",
          "data": {
            "code": "reg [8:0] q=0;\n\nalways @(posedge clk)\n  if (load)\n    q <= d;",
            "params": [],
        ...
        {
          "id": "901038b6-2d89-412d-829c-4a50b0942010",
          "type": "basic.info",
          "data": {
            "info": "Ha llegado a funcionar. La inicializacion todavía no la tengo controlada\n\nLos comandos enviar desdpues del arranque son (9 bits)\n\n0x0C0  ---> SET\n0x0F0  ---> Display on/off\n0x141 --> Enviar la A\n\n",
            "readonly": false
          },
          "position": {
            "x": 2720,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "a4fd391e-1c22-4610-813d-2943b5fe0483",
            "port": "q"
          },
          "target": {
            "block": "866a1820-9be3-4260-b9ec-adafc9237cf9",
        ...
        {
          "source": {
            "block": "9ff44a7b-d11d-4e4a-9065-5dff987d5a49",
            "port": "o"
          },
          "target": {
